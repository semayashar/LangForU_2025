    ...
    t.extend(t.validator, {
      ...
      messages: {
          ...
          maxlength: t.validator.format(
            "Моля, въведете не повече от {0} знака."
          ),
          minlength: t.validator.format("Моля, въведете поне {0} знака."),
          rangelength: t.validator.format(
            "Моля, въведете стойност между {0} и {1} знака."
          ),
          range: t.validator.format("Моля, въведете стойност между {0} и {1}."),
          max: t.validator.format(
            "Моля, въведете стойност, която е по-малка или равна на {0}."
          ),
          min: t.validator.format(
            "Моля, въведете стойност, която е по-голяма или равна на {0}."
          ),
      },
      autoCreateRanges: !1,
      prototype: {
